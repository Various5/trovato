...
_DICT: dict[str, dict[str, str]] = {
    "en": {
        ...
        "sources.delete_help": "Documents already indexed from it are kept; the connection and its credentials are removed.",
    ...
    "de": {
        ...
        "sources.delete_help": "Bereits indexierte Dokumente bleiben erhalten; die Verbindung und ihre Zugangsdaten werden entfernt.",
